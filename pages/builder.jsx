...
//         className="md:hidden p-2 text-white bg-purple-700 fixed top-4 left-4 z-50 rounded"
//       >
//         ☰
//       </button>
...
//         }`}
//       >
//         <ul className="space-y-5 mt-4 font-ubuntu">
//           <li>
//             <Link
//               href=""
...
//                 className="rounded-lg border-2 bg-purple-800  w-full lg:w-40 text-white px-10 py-1"
//               >
//                 Previous
//               </button>
//               <button
...
//                 className="rounded-lg border-2 bg-yellow-500  w-full lg:w-40 text-black px-10 py-1"
//               >
//                 {currentSection === sections.length - 1 ? "Finish" : "Next"}
//               </button>
//               <div className="lg:flex gap- content-center  justify-between bg-gray-100 p-1 px-5 lg:block hidden">
//                 <select
//                   value={selectedFont}
//                   onChange={handleFontChange}
//                   className="rounded-lg border border-purple-700 px-8 py-2 font-bold text-purple-700 "
//                 >
...
//                   value={selectedFont}
//                   onChange={handleFontChange}
//                   className="rounded-lg border-2 border-purple-700 lg:px-8 p-2 m-2 font-bold bg-white text-purple-700"
//                 >
//                   <option value="Ubuntu">Ubuntu</option>
//                   <option value="Calibri">Calibri</option>
//                   <option value="Georgia">Georgia</option>
...
//               <button
//                 type="button"
//                 className="rounded-lg px-10 lg:ms-2 font-bold bg-purple-700 text-white p-1"
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <select
            value={selectedFont}
            onChange={handleFontChange}
            className="w-40 h-10 rounded-lg border-2 border-purple-700 px-4 font-bold text-purple-700 bg-white focus:outline-none focus:ring-2 focus:ring-blue-800"
          >
            <option value="Ubuntu">Ubuntu</option>
            <option value="Calibri">Calibri</option>
            <option value="Georgia">Georgia</option>
              ...
              className={`
                ...
                ${
                  currentSection === index 
                    ? "rounded-lg border-2 border-purple-800 font-bold bg-purple-950 text-white" 
                    : "border-2 bg-white border-purple-800 rounded-lg text-purple-800"
                }
              `}
              onClick={() => handleSectionClick(index)}
            >
