...
//     <div className='  '>
//       <section className="dark:bg-blue-200">
//         <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
//           <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
//             <h2 className="mb-4 text-5xl font-sans font-medium rounded-2xl border-4 p-3">Choose a <span className='text-purple-700'>Plan, </span>Which is right for you?</h2>
//           </div>
  ...
  const handlePayment1 = (e) => {
    ...
    <div className='  '  data-aos="fade-up">
      <section className="dark:bg-blue-200">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 className="mb-4 text-5xl font-ubuntu font-medium rounded-2xl border-4 p-3">Choose a <span className='text-purple-700'>Plan, </span>Which is right for you?</h2>
          </div>
          <div className="space-y-4 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            {/* Pricing Card */}
            ...
            {/* Pricing Card */}
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-gray-100 rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-bold  text-purple-700 ">Resume Builder</h3>
              <p className="font-light sm:text-lg dark:text-white">Relevant for automation &amp; one time download.</p>
              <div className="flex justify-center items-baseline my-8 gap-3">
                <span className="dark:text-white ">Starting { " "}</span>
                <span className="mr-2 text-5xl font-extrabold">$49</span>
              </div>
              {/* List */}
              <ul role="list" className="mb-8 space-y-4 text-left">
            ...
            {/* Pricing Card */}
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-gray-100 rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-bold text-purple-700">Expert Human Writer</h3>
              <p className="font-light sm:text-lg dark:text-white">Best for large scale uses and extended redistribution rights.</p>
              <div className="flex justify-center items-baseline my-8">
                <span className="mr-2 text-5xl font-extrabold">$269</span>
...
{showModal1 && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-gray-100 rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-bold text-purple-700"> French English Combo</h3>
              <p className="font-light sm:text-lg dark:text-white">Best for large scale uses and extended redistribution rights.</p>
              <div className="flex justify-center items-baseline my-8">
                <span className="mr-2 text-5xl font-extrabold">$349</span>
                <span className="dark:text-white">/Resume</span>
