          ...
          <div className='flex flex-col justify-center gap-5 items-center md:flex-row'>
            {[
              ...
              <div key={index} className='relative group'>
                ...
                <h1 className='font-bold text-xl text-center mt-2' id='homecard'>{template.title}</h1>
                <Link href="/dashboard/profile">
                  <button className='absolute top-0 left-0 right-0 bottom-0 m-auto w-fit h-fit bg-white text-purple-700 border-2 border-purple-800 font-bold py-2 px-4 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300' id='home_third'>Create Your Resume</button>
                </Link>
              </div>
            ))}
          </div>
        ...
        Explore from our <span className="text-purple-700 font-bold">25+ premium Cover Letters,</span> which are exclusively crafted by our Experts.
          ...
          <div className='flex flex-col justify-center gap-5 items-center md:flex-row'>
            {[
              ...
              <div key={index} className='relative group'>
                <Image src={template.src} alt={template.alt} className='h-[400px] w-full border-2 '/>
                <h1 className='font-bold text-xl text-center mt-2' id='homecard'>{template.title}</h1>
                <Link href="/dashboard/profile">
